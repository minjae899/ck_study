...
import spring.common.dao.CommonMapper;
...
public class Util {
	...
	* 월단위로 로그인한 자신의 지각비의총액을 계산한다.
	 */
	public String sumMyPenalty(List<HashMap<String, ArrayList<MemberVO>>> list, String targetId){
		String result = "";
		int penalty = 0;
	...
	* 아이피 체크하는 로직.
	 */
	public boolean checkIp(String targetIp){
		boolean result = true;
